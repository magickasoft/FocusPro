        ...
        return (
            <View style={styles.container}>
                ...
                <ScrollView style={styles.menu} contentContainerStyle={{justifyContent:'space-between'}}>
                    <MenuItem imageItemSource={require('../images/icon/dashboard.png')} textItem='Schedule' onPressItem={()=>this.onWebViewPage('dashboard')}/>
                    <MenuItem imageItemSource={require('../images/icon/account.png')} textItem='Accounts' onPressItem={()=>this.onWebViewPage('account')}/>
                    <MenuItem imageItemSource={require('../images/icon/fitness.png')} textItem='Media' onPressItem={()=>this.onWebViewPage('fitness')}/>
                    <MenuItem imageItemSource={require('../images/icon/mind.png')} textItem='Notifications' onPressItem={()=>this.onWebViewPage('mind')}/>
                    <MenuItem imageItemSource={require('../images/icon/place.png')} textItem='Settings' onPressItem={()=>this.onWebViewPage('social')}/>
                    <MenuItem imageItemSource={require('../images/icon/social.png')} textItem='My profile' onPressItem={()=>this.onWebViewPage('place')}/>
                    <MenuItem imageItemSource={require('../images/icon/logout.png')} textItem='Logout' onPressItem={()=>this.onLogOut()}/>
                </ScrollView>
            </View>
        );
    }
